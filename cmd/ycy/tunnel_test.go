...
func TestTunnelConnectionSelectorLeavesAutomationResolutionAmbiguousWithoutReadingInput(t *testing.T) {
	...
	_, err := tunnel.ResolveClientConfig(context.Background(), tunnel.ClientOptionInput{}, tunnel.ClientResolutionOptions{
	...
	resolved, err := tunnel.ResolveClientConfig(context.Background(), tunnel.ClientOptionInput{}, tunnel.ClientResolutionOptions{
